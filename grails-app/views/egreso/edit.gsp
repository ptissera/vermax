...
<html>
	...
	<body>
		...
		<div id="edit-egreso" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${egresoInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${egresoInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:egresoInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${egresoInstance?.version}" />
				<fieldset class="form">
